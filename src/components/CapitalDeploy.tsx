...
export function CapitalDeploy({
  ...
  return (
    <section
      ref={sectionRef}
      className={shell}
      aria-label="Extra Cash — where to deploy it"
      data-capital-deploy
    >
      <header className="flex flex-wrap items-start justify-between gap-3 border-b border-white/10 px-4 py-3">
        <div>
          ...
          <p className="mt-0.5 text-xs text-slate-500">
            Compares three uses for spare cash — paying down a loan, building a cash reserve, or
            saving toward the next purchase — and recommends the best one.
          </p>
        </div>
